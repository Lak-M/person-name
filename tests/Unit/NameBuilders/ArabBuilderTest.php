...
it('can create a person name from full name', function (
    ...
    expect($n1)->toBeInstanceOf(Arab::class)
        ...
        ->and($n1->ism())->toBe($ism)
        ->and($n1->father() ? mb_strtolower($n1->father()) : null)->toBe($fatherName ? mb_strtolower($fatherName) : null)
        ->and($n1->grandfather() ? mb_strtolower($n1->grandfather()) : null)->toBe($grandfatherName ? mb_strtolower($grandfatherName) : null)
